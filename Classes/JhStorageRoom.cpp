...
std::map<int, std::vector<PackageData>> JhStorageRoom::map_storageData;
JhStorageRoom::JhStorageRoom()
{
}
...
void JhStorageRoom::loadStorageData()
{
	std::map<int, std::vector<PackageData>>::iterator it;
	for (it = map_storageData.begin(); it != map_storageData.end(); ++it)
	{
...
void JhStorageRoom::add(PackageData data)
{
...
void JhStorageRoom::use(std::string strid, int count)
{
	std::map<int, std::vector<PackageData>>::iterator it;
	for (it = map_storageData.begin(); it != map_storageData.end(); ++it)
	{
...
void JhStorageRoom::use(PackageData data)
{
	std::map<int, std::vector<PackageData>>::iterator it;
	for (it = map_storageData.begin(); it != map_storageData.end(); ++it)
	{
...
int JhStorageRoom::getCountById(std::string strid)
{
	std::map<int, std::vector<PackageData>>::iterator it;
	for (it = map_storageData.begin(); it != map_storageData.end(); ++it)
	{
