...
class JhBuildingUILayer :public Layer, public ServerDataDelegateProtocol
{
public:
	JhBuildingUILayer();
	~JhBuildingUILayer();

	virtual bool init(JhBuilding* build);
	virtual void onEnterTransitionDidFinish();

	static JhBuildingUILayer* create(JhBuilding* build);
