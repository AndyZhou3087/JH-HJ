...
\n捐赠1银两可获得1点贡献度。\
\n捐赠1元宝可获得10点贡献度。";
JhFactionDetailsLayer::JhFactionDetailsLayer()
{
}
...
JhFactionDetailsLayer* JhFactionDetailsLayer::create()
{
	JhFactionDetailsLayer *pRet = new JhFactionDetailsLayer();
	if (pRet && pRet->init())
	{
		pRet->autorelease();
	}
...
bool JhFactionDetailsLayer::init()
{
	...
	closebtn->addTouchEventListener(CC_CALLBACK_2(JhFactionDetailsLayer::onClose, this));
	...
	Label* contentlbl = Label::createWithTTF(JhCommonFuncs::gbk2utf(desc.c_str()), "fonts/SIMHEI.TTF", 20);
...
void JhFactionDetailsLayer::onClose(cocos2d::Ref *pSender, cocos2d::ui::Widget::TouchEventType type)
{
