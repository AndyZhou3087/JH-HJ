...
bool JhBuildingDetailsLayer::init(JhBuilding* pdata)
{
	...
	okbtn->addTouchEventListener(CC_CALLBACK_2(JhBuildingDetailsLayer::onOk, this));
...
JhBuildingDetailsLayer* JhBuildingDetailsLayer::create(JhBuilding* pdata)
{
	JhBuildingDetailsLayer *pRet = new JhBuildingDetailsLayer();
...
void JhBuildingDetailsLayer::onOk(cocos2d::Ref *pSender, cocos2d::ui::Widget::TouchEventType type)
{
...
void JhBuildingDetailsLayer::removSelf()
{
