...
class JhServerDataSwap
{
public:

	static JhServerDataSwap* init(ServerDataDelegateProtocol* delegateProtocol = NULL);
...
private:
	...
	JhServerDataSwap();
	~JhServerDataSwap();
	JhServerDataSwap(ServerDataDelegateProtocol *pDelegateProtocol);
	void release();
private:
