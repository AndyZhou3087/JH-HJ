...
#include "JhHintBox.h"
JhSepcialNpcLayer::JhSepcialNpcLayer()
{
...
JhSepcialNpcLayer* JhSepcialNpcLayer::create(std::string addrname)
{
	JhSepcialNpcLayer *pRet = new JhSepcialNpcLayer();
...
bool JhSepcialNpcLayer::init(std::string addrid)
{
	m_addrstr = addrid;
	...
	backbtn->addTouchEventListener(CC_CALLBACK_2(JhSepcialNpcLayer::onBack, this));

	cocos2d::ui::Widget* fightbtn = (cocos2d::ui::Button*)m_csbnode->getChildByName("fightbtn");
	fightbtn->addTouchEventListener(CC_CALLBACK_2(JhSepcialNpcLayer::onFight, this));
...
void JhSepcialNpcLayer::onEnterTransitionDidFinish()
{
	Layer::onEnterTransitionDidFinish();
}

void JhSepcialNpcLayer::onBack(cocos2d::Ref *pSender, cocos2d::ui::Widget::TouchEventType type)
{
...
void JhSepcialNpcLayer::onFight(cocos2d::Ref *pSender, cocos2d::ui::Widget::TouchEventType type)
{
	JhCommonFuncs::BtnAction(pSender, type);
	if (type == ui::Widget::TouchEventType::ENDED)
	{
