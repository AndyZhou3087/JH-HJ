...
bool JhVipGoodsItem::init(GoodsData* gdata)
{
	...
	bgbtn->addTouchEventListener(CC_CALLBACK_2(JhVipGoodsItem::onItem, this));
	...
	m_buybtn->addTouchEventListener(CC_CALLBACK_2(JhVipGoodsItem::onBuyBtn, this));
	m_buybtn->setSwallowTouches(false);

	updateLeftDays(0);
	this->schedule(schedule_selector(JhVipGoodsItem::updateLeftDays), 1.0f);

	return true;
}

JhVipGoodsItem* JhVipGoodsItem::create(GoodsData* gdata)
{
	JhVipGoodsItem *pRet = new JhVipGoodsItem();
...
void JhVipGoodsItem::onBuyBtn(cocos2d::Ref *pSender, cocos2d::ui::Widget::TouchEventType type)
{
	JhCommonFuncs::BtnAction(pSender, type);
}

void JhVipGoodsItem::onItem(cocos2d::Ref *pSender, cocos2d::ui::Widget::TouchEventType type)
{
...
void JhVipGoodsItem::updateLeftDays(float dt)
{
